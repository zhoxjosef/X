...
GAME_BUTTONS = [
    [ 
        ...
        InlineKeyboardButton ('★¦العاب هولي ⁩', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('‹ 𓆩␥⬳᩺𝕁𝕆𝕊𝔼𝔽𑑛𓆪 ›⁩', url =f"https://t.me/JOSEFI0")              
                 ],[
...
async def callback_query(client, CallbackQuery):
        ...
        InlineKeyboardButton ('‹ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒉𝒐𝒐𝒍𝒍𝒚 ›⁩', url =f"https://t.me/JOSEFI0")              
                 ],[
                InlineKeyboardButton(
                        "◁", callback_data="close"),
               ],
               ...
               SOURCE_GAME = "★¦العاب هولي\n★¦كت\n★¦تويت\n★¦اسال\n★¦اصراحه\n\n" 

               SORGAM_BUTTON = [
                    [ 
                      InlineKeyboardButton ('⌞𓆩␥⬳᩺𝕁𝕆𝕊𝔼𝔽𑑛𓆪⌝⚡️', url =f"https://t.me/JOSEFI0")
                      ],[
