...
async def get_group_call(
    ...
    await message.edit(f"**لم يتم العثور على اتصال** {err_msg}")
    return False


@app.on_message(
    filters.command("فتح الاتصال") & filters.group & filters.channel
)
...
@app.on_message(
    filters.regex("اغلاق الاتصال") & filters.group & filters.channel
)
